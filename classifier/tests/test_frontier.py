...
from classifier.frontier import (attempted_path, build_pools, domain_of_url,
                                  kept_by_label, kept_domains, load_attempted,
                                  load_ranks, remaining)
...
def test_build_pools_denylist_drops_matching_substrings(tmp_path):
    ...
    tsv.write_text("x.blogspot.com\tadult\nporn.com\tadult\ntaboola.com\tadult\n",
                   encoding="utf-8")
    pools = build_pools(tsv, ["adult"], seed=0,
                        denylist=("blogspot", "taboola"))
...
def test_build_pools_popular_first_orders_by_rank(tmp_path):
    ...
    tsv.write_text("low.com\tadult\ntop.com\tadult\nmid.com\tadult\n"
                   "obscure.com\tadult\n", encoding="utf-8")
    ranks = {"top.com": 5, "mid.com": 50, "low.com": 500}
    pools = build_pools(tsv, ["adult"], seed=0, popular_first=("adult",),
                        ranks=ranks)
...
def test_build_pools_popular_first_only_affects_listed_labels(tmp_path):
    ...
    pools = build_pools(tsv, ["games"], seed=0, popular_first=("adult",),
                        ranks=ranks)
