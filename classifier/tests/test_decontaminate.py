...
def test_flags_casino_with_two_signals():
    assert (
        contamination_category(_rec("Best online casino welcome bonus play slots and roulette now"))
        == "gambling"
    )
    ...
    assert (
        contamination_category(
            _rec(
                ...
                "after a long debate about traffic and parking for residents"
            )
        )
        is None
    )
...
def test_explicit_adult_vocabulary_flags():
    assert (
        contamination_category(
            _rec("Free porn videos xxx hardcore nude camgirl live sex cams updated daily")
        )
        == "adult"
    )
    ...
    assert (
        contamination_category(
            _rec(
                ...
                "for children and parents who want a calm relaxed pace of learning"
            )
        )
        is None
    )
    ...
    assert (
        contamination_category(
            _rec(
                ...
                "anonymously through our online proxy"
            )
        )
        == "proxy-bypass"
    )
...
def test_partition_only_touches_clean_rows():
    recs = [
        _rec("online casino slots jackpot", label="clean"),
